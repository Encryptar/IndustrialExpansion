...
public final class ItemInit {
    ...
    public static final RegistryObject<BlockItem> RUBBER_LOG = ITEMS.register("rubber_log",() -> new BlockItem(BlockInit.RUBBER_LOG.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> STRIPPED_RUBBER_LOG = ITEMS.register("stripped_rubber_log",() -> new BlockItem(BlockInit.STRIPPED_RUBBER_LOG.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> RUBBER_WOOD = ITEMS.register("rubber_wood",() -> new BlockItem(BlockInit.RUBBER_WOOD.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> STRIPPED_RUBBER_WOOD = ITEMS.register("stripped_rubber_wood",() -> new BlockItem(BlockInit.STRIPPED_RUBBER_WOOD.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> RUBBER_LEAVES = ITEMS.register("rubber_leaves",() -> new BlockItem(BlockInit.RUBBER_LEAVES.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    ...
    public static final RegistryObject<BlockItem> RUBBER_STAIRS = ITEMS.register("rubber_stairs",() -> new BlockItem(BlockInit.RUBBER_STAIRS.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> RUBBER_SLAB = ITEMS.register("rubber_slab",() -> new BlockItem(BlockInit.RUBBER_SLAB.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> RUBBER_FENCE = ITEMS.register("rubber_fence",() -> new BlockItem(BlockInit.RUBBER_FENCE.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> RUBBER_FENCE_GATE = ITEMS.register("rubber_fence_gate",() -> new BlockItem(BlockInit.RUBBER_FENCE_GATE.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    ...
    public static final RegistryObject<BlockItem> SAPPHIRE_BLOCK = ITEMS.register("sapphire_block",() -> new BlockItem(BlockInit.SAPPHIRE_BLOCK.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> SAPPHIRE_ORE = ITEMS.register("sapphire_ore",() -> new BlockItem(BlockInit.SAPPHIRE_ORE.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> DEEPSLATE_SAPPHIRE_ORE = ITEMS.register("deepslate_sapphire_ore",() -> new BlockItem(BlockInit.DEEPSLATE_SAPPHIRE_ORE.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    ...
    public static final RegistryObject<Item> SAPPHIRE_SHOVEL = ITEMS.register("sapphire_shovel",() -> new ShovelItem(ToolInit.GEM, 1.5F, -3.0F, (new Item.Properties()).tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<Item> SAPPHIRE_PICKAXE = ITEMS.register("sapphire_pickaxe", () -> new PickaxeItem(ToolInit.GEM, 1, -2.8F, (new Item.Properties()).tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<Item> SAPPHIRE_AXE = ITEMS.register("sapphire_axe", () -> new AxeItem(ToolInit.GEM, 5.0F, -3.0F, (new Item.Properties()).tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<Item> SAPPHIRE_HOE = ITEMS.register("sapphire_hoe", () -> new HoeItem(ToolInit.GEM, -3, 0.0F, (new Item.Properties()).tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    ...
    public static final RegistryObject<BlockItem> RUBY_BLOCK = ITEMS.register("ruby_block",() -> new BlockItem(BlockInit.RUBY_BLOCK.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> RUBY_ORE = ITEMS.register("ruby_ore",() -> new BlockItem(BlockInit.RUBY_ORE.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<BlockItem> DEEPSLATE_RUBY_ORE = ITEMS.register("deepslate_ruby_ore",() -> new BlockItem(BlockInit.DEEPSLATE_RUBY_ORE.get(), new Item.Properties().tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    ...
    public static final RegistryObject<Item> RUBY_SHOVEL = ITEMS.register("ruby_shovel",() -> new ShovelItem(ToolInit.GEM, 1.5F, -3.0F, (new Item.Properties()).tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
    public static final RegistryObject<Item> RUBY_PICKAXE = ITEMS.register("ruby_pickaxe", () -> new PickaxeItem(ToolInit.GEM, 1, -2.8F, (new Item.Properties()).tab(IndustrialExpansion.IndustrialExpansionCreativeTab)));
